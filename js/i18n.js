const translations = {
  en: {
    ...
    toastNoMoreForks: 'No more forks to load.',
    ...
    githubTokenTitle: 'GitHub Token (PAT)',
    githubTokenLabel: 'GitHub Personal Access Token (PAT)',
    toastTokenSaved: 'GitHub Token saved successfully!',
    toastTokenCleared: 'GitHub Token cleared successfully!',
    clear: 'Clear',
    save: 'Save',
  },
  tr: {
    ...
    toastNoMoreForks: 'Yüklenecek başka fork kalmadı.',
    ...
    githubTokenTitle: 'GitHub Token (PAT)',
    githubTokenLabel: 'GitHub Kişisel Erişim Anahtarı (PAT)',
    toastTokenSaved: 'GitHub Token başarıyla kaydedildi!',
    toastTokenCleared: 'GitHub Token başarıyla temizlendi!',
    clear: 'Temizle',
    save: 'Kaydet',
  },
  de: {
    ...
    toastNoMoreForks: 'Keine weiteren Forks zu laden.',
    ...
    githubTokenTitle: 'GitHub Token (PAT)',
    githubTokenLabel: 'GitHub Personal Access Token (PAT)',
    toastTokenSaved: 'GitHub-Token erfolgreich gespeichert!',
    toastTokenCleared: 'GitHub-Token erfolgreich gelöscht!',
    clear: 'Löschen',
    save: 'Speichern',
  },
  zh: {
    ...
    toastNoMoreForks: '没有更多 Fork 可以加载。',
    ...
    sortOldest: '排序: 最早创建',
    sortWatchers: '排序: 关注者',
    githubTokenTitle: 'GitHub 令牌 (PAT)',
    githubTokenLabel: 'GitHub 个人访问令牌 (PAT)',
    toastTokenSaved: 'GitHub 令牌已成功保存！',
    toastTokenCleared: 'GitHub 令牌已成功清除！',
    clear: '清除',
    save: '保存',
  },
};

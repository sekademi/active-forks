const translations = {
  en: {
    ...
    fetchAllForks: 'Load all forks',
    fetchAllForksWarning: 'Warning: loading all forks may use multiple GitHub API requests and count against your rate limit. Continue?',
    cancelFetch: 'Cancel',
    toastFetchCanceled: 'Fork loading canceled.',
    toastAllForksFetchComplete: 'All forks loaded successfully!',
    toastLoadedCachedData: 'Loaded cached data because network fetch failed.',
    toastExportSuccess: 'Export completed successfully!',
    errorNoDataExport: 'No fork data available to export.',
  ...
  tr: {
    ...
    export: 'Dışa Aktar',
    exportThisPage: 'Bu Sayfa',
    exportAllData: 'Tüm Veri',
    fetchAllForks: 'Tüm forkları yükle',
    fetchAllForksWarning: 'Uyarı: tüm forklar birkaç GitHub API isteği kullanabilir ve hız limiti üzerinde etkisi olabilir. Devam edilsin mi?',
    cancelFetch: 'İptal Et',
    toastFetchCanceled: 'Fork yükleme işlemi iptal edildi.',
    toastAllForksFetchComplete: 'Tüm forklar başarıyla yüklendi!',
    toastLoadedCachedData: 'Ağ hatası nedeniyle önbelleğe alınmış veriler yüklendi.',
    toastExportSuccess: 'Dışa aktarma başarıyla tamamlandı!',
    errorNoDataExport: 'Dışa aktarılacak fork verisi bulunamadı.',
  ...
  de: {
    ...
    export: 'Exportieren',
    exportThisPage: 'Diese Seite',
    exportAllData: 'Alle Daten',
    fetchAllForks: 'Alle Forks laden',
    fetchAllForksWarning: 'Warnung: Das Laden aller Forks kann mehrere GitHub-API-Anfragen auslösen und dein Limit belasten. Fortfahren?',
    cancelFetch: 'Abbrechen',
    toastFetchCanceled: 'Fork-Ladevorgang abgebrochen.',
    toastAllForksFetchComplete: 'Alle Forks wurden erfolgreich geladen!',
    toastLoadedCachedData: 'Geladene zwischengespeicherte Daten, da die Netzabfrage fehlgeschlagen ist.',
    toastExportSuccess: 'Export erfolgreich abgeschlossen!',
    errorNoDataExport: 'Keine Fork-Daten zum Exportieren vorhanden.',
  ...
  zh: {
    ...
    exportThisPage: '当前页',
    exportAllData: '所有数据',
    fetchAllForks: '加载所有 Fork',
    fetchAllForksWarning: '警告：加载所有 Fork 可能会使用多个 GitHub API 请求并消耗速率限制。是否继续？',
    cancelFetch: '取消',
    toastFetchCanceled: 'Fork 加载已取消。',
    toastAllForksFetchComplete: '所有 Fork 已成功加载！',
    toastLoadedCachedData: '由于网络获取失败，已加载本地缓存的数据。',
    toastExportSuccess: '导出已成功完成！',
    errorNoDataExport: '没有可导出的 Fork 数据。',
